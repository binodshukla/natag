...
ob_start();
/**
 * Template Name: Update Fertilizer
 * @package WordPress
 * @subpackage natag
 */
...
if($submit == 'Send')
{
	...
	if($no_not == '')
	{
		if($email_not == 'Email')
		{
			...
			$subject = "Fertilizer Request";
			$message = get_option('fert_price_message');
	 	...
	 	<div style="border: 1px dotted #C0C0C0; width: 600px; padding-right: 30px; padding-left: 20px; padding-bottom: 50px;font-family:Arial, Helvetica, sans-serif;font-size:12px;">  
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text"  name="post_type" value="<?php echo $post_type; ?>" style="width: 410px" ></div>
			...
			<div>
				...
				<div style="width:136px; float:left;" class="auto-style2">
					<input type="text" name="quote_price" value="<?php echo get_post_meta($id,'price_qoute',true); ?>" style="width: 121px" ></div>
