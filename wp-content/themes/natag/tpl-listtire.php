...
<?php
			$myrows = $wpdb->get_results( "SELECT wp_posts.ID,wp_posts.post_title,wp_posts.post_status,wp_posts.post_name,wp_posts.post_date from wp_posts where wp_posts.post_type='tire' and (wp_posts.post_status='sent' or wp_posts.post_status='publish') order by wp_posts.ID DESC " );
            $ct=1;
...
?>
			...
			?>
            	...
            	<td align="left" class="listtdlast">
					<a href="<?php echo get_option('siteurl')?>/?page_id=519&post_id=<?php echo $id?>">View-Request</a>
                    &nbsp;&nbsp;<a href="JavaScript:newPopup('<?php echo get_option('siteurl')?>/?page_id=547&type=tire&post_id=<?php echo $id?>')">Print</a>
