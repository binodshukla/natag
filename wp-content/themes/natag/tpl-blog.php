		...
		<div class="clr"></div>
			...
			<div class="article_box">
							...
							<?php if(have_posts()):while(have_posts()):the_post(); ?>
                                	...
                                	<div class="article" style="border-bottom:1px dotted #ACACAC; padding-top:10px;padding-bottom:15px;">
									...
									<div class="postmetadata">Posted on <?php the_time(get_option('date_format')) ?>, <?php the_time(get_option('time_format')) ?>, by <?php the_author() ?>
						</div>	
