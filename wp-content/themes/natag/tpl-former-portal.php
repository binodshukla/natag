...
?>		
					<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<h3><?php /* Page Title */
  							...
  							<?php
								if(count($feedback_data)>0 && $feedback_data[0]->feedback_status == 0)
								{
									?>
                                    <div id="survey_message">
                                    	You have a feedback pending. <a href="<?php echo get_option('siteurl')?>/?page_id=577">Accept</a> or <a href="<?php echo get_option('siteurl')?>/?page_id=596&message_id=<?php echo $feedback_data[0]->id; ?>">Decline</a>
                                    </div>
                                    <?php
								}
							?>
