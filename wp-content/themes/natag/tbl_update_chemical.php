...
if($submit == 'Send')
{
	...
	if($no_not == '')
	{
		if($email_not == 'Email')
		{
			...
			$subject = "Chemical Request";
			$message = "You have recieve a Chemical Request Price, Please check you Account";
    	...
    	<form action="" method="post" name="fertrequest" onsubmit="return confirm('Are you sure you want to submit?')">
	 	<div style="border: 1px dotted #C0C0C0; width: 600px; padding-right: 30px; padding-left: 20px; padding-bottom: 50px;font-family:Arial, Helvetica, sans-serif;font-size:12px;">  
            <div style="text-align:left;">
				...
				<div style="width:165px; float:left;"><input type="text" name="cname" value="<?php echo get_post_meta($id,'code_number',true); ?>" style="width:170px" ></div>
			</div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="item_name" value="<?php echo get_post_meta($id,'item_name',true); ?>" style="width: 410px" ></div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="total_amount" value="<?php echo get_post_meta($id,'quantity',true); ?>" style="width: 412px" ></div>
			</div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="packaged" value="<?php echo get_post_meta($id,'packaged',true); ?>" style="width: 412px" >
                </div>
			</div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" value="<?php echo get_post_meta($id,'delivery_date',true); ?>" name="delivery_date" style="width: 412px" ></div>
			...
			<div>
				...
				Quote needed by  				</div>
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="quote_date" value="<?php echo get_post_meta($id,'quote_date',true); ?>" style="width: 412px" ></div>
			...
			<div style="clear:both;">
				...
				?>
                    ...
                    <div style="float:left;">
                        <input name="use_fertilizer" type="radio" value="<?php echo $u?>" checked="checked" style="width: 79px" />
                    </div>
                <?php		
					}
					else
				...
				?>
                    <div style="float:left;"><?php echo $u?>   </div>
                    <div style="float:left;">
                        <input name="use_fertilizer" type="radio" value="<?php echo $u?>" style="width: 79px" />
                    </div>
                <?php		
					}
				}
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="app_cost" value="<?php echo get_post_meta($id,'app_cost',true); ?>" style="width: 412px" >
                </div>
			</div>
			...
			<div>
				...
				<div style="width:136px; float:left;" class="auto-style2">
					<input type="text" name="quote_price" value="<?php echo get_post_meta($id,'price_quote',true); ?>" style="width: 121px" ></div>
					<div style="float:left;width: 117px; " class="auto-style2">
				Savings offered $				</div>
				<div style="  float:right;text-align:right; width: 138px;" class="auto-style1">
					<input type="text" name="saving_offer" value="<?php echo get_post_meta($id,'saving_offer',true); ?>" style="width: 104px" ></div>
