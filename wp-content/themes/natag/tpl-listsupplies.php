 ...
 * @package WordPress
 * @subpackage natag
 * Template Name:List of Supplies
 */
...
<?php
			$myrows = $wpdb->get_results( "SELECT wp_posts.ID,wp_posts.post_title,wp_posts.post_status,wp_posts.post_name,wp_posts.post_date from wp_posts where wp_posts.post_type='supplies' and (wp_posts.post_status='sent' or wp_posts.post_status='publish') order by wp_posts.ID DESC " );
            $ct=1;
