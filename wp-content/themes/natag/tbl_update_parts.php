...
if($submit == 'Send')
{
	...
	if($no_not == '')
	{
		if($email_not == 'Email')
		{
			...
			$message = get_option('part_price_message');
...
?>
    	<form action="" method="post" name="parts" onsubmit="return confirm('Are you sure you want to submit?')">
	 	<div style="border: 1px dotted #C0C0C0; width: 600px; padding-right: 30px; padding-left: 20px; padding-bottom: 50px;font-family:Arial, Helvetica, sans-serif;font-size:12px;">  
			...
			<div style="width:88px; float:left;text-align:left;">How many </div>
				<div style="width:219px; float:left;text-align:left;">
					<input type="text" name="quantity" value="<?php echo get_post_meta($id,'quantity',true); ?>" style="width:173px;" ></div>
				<div style="width:119px; float:left;text-align:left;">
					Part Name</div>
				<div style="width:170px; float:left;">
					<input type="text" name="part_name" value="<?php echo get_post_meta($id,'part_name',true); ?>" style="width: 170px" ></div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="type" value="<?php echo get_post_meta($id,'vehicle_type',true); ?>" style="width: 412px" ></div>
			...
			<div>
				...
				Brand name  				</div>
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="brand_name" value="<?php echo get_post_meta($id,'brand_name',true); ?>" style="width: 410px" ></div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="model" value="<?php echo get_post_meta($id,'model',true); ?>" style="width: 412px" ></div>
			</div>
			...
			<div>
				...
				<div style="width:413px; float:left;text-align:right;">
					<input type="text" name="serial_no" value="<?php echo get_post_meta($id,'serial_no',true); ?>" style="width: 410px" ></div>
			...
			<div>
				...
				<div style="width: 100px; float:left;text-align:left">
						...
						<input checked="checked" name="applicable" type="radio"  value="<?php echo $ap?>"/> 
				<?php echo $ap?>  
				</div>
                <?php		
					}
				...
				<div style="width: 100px; float:left;text-align:left">
						...
						<input name="applicable" type="radio"  value="<?php echo $ap?>"/> 
				<?php echo $ap?>  
				</div>
                <?php		
					}	
