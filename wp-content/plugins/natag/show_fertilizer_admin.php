  		...
  		<table border="0" cellpadding="0px" width="100%" align="center" cellspacing="0">
            ...
            <tr>
            	<th align="center" colspan="15" style="border-bottom:1px solid #333;">
                	<span style="font-size:17px; font-family:Arial, Helvetica, sans-serif; color:#333;">All Fertilizers</span>
                </th>
            </tr>
			<tr>
            	<td colspan="15">&nbsp;
...
<?php
			$myrows = $wpdb->get_results( "SELECT wp_posts.ID,wp_posts.post_title,wp_posts.post_status,wp_posts.post_name from wp_posts where wp_posts.post_type='fertilizer' order by wp_posts.ID DESC " );
            $ct=1;
